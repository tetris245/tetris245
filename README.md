...
* Rewrote function to neutralize validation only for yourself, it means that other players will not see your real full appearance. Important note for BCX users: don't curse items that are incompatible according validation rules!
