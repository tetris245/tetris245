...
* New command: diaper to play with diapers (ABDL game). List of actions: refresh1, refresh2, refresh3, run, stop, tick. You need to wear one or two layers of diapers (only bulky and poofy versions).
